...
const DashboardBlockCard: React.FC<Props> = () => {
  return (
    <div className="p-7 bg-[#121f02] w-[220px] h-[220px] rounded-xl border border-brand-green-bright">
      <p className="text-sm mb-6 font-bold tracking-widest text-[#8EFF01] w">
        Revenue
      </p>
      ...
      <button className="text-[#fff] w-full bg-[#000] py-3 rounded-xl flex justify-center items-center">
        <img
          className="mr-2"
